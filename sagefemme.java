 ...
 * @author SnowGirl
 */
public class sagefemme extends javax.swing.JFrame {

    /**
     * Creates new form sagefemme
     */
    public sagefemme() {
        initComponents();
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
         setTitle("Gestion de Maternié: Login Sage-Femme");
...
setIconImage(image);
    ...
    private void initComponents() {
        ...
        home.setIcon(new javax.swing.ImageIcon("D:\\5.Etude\\3rd Year Licence\\Projet de fin d'etude\\icones\\home.png")); // NOI18N
        ...
        jLabel6.setText("Sage-Femme: Panneau de connexion");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(home1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jLabel4))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel6)
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try{
            ...
            String query ="select pseudo, password from nurse where pseudo=? and password=?";
            ...
            if (count==1) {
                interfaceSagefemme a = new interfaceSagefemme();
                a.setVisible(true);
                dispose();
            }
            else if (count >1) {
...
int xy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sagefemme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
