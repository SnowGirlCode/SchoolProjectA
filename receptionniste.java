...
setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
         setTitle("Gestion de Maternié: Login Réceptionniste");
...
setIconImage(image);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Receptionniste: Panneau de connexion");
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try{
            ...
            String query ="select pseudo, password from receptionniste where pseudo=? and password=?";
            ...
            if (count==1) {
                interfaceRecept a = new interfaceRecept();
                a.setVisible(true);
                dispose();
            }
            else if (count >1) {
